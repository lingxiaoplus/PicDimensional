...
public class RecyclerViewAnimator extends SimpleItemAnimator {
        ...
        public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
            ...
            if (newHolder != null) {
                ...
                newHolder.itemView.setScaleX(0f);
                newHolder.itemView.setScaleY(0f);
            }
        ...
        void animateChangeImpl(final ChangeInfo changeInfo) {
            ...
            if (view != null) {
                ...
                oldViewAnim.alpha(0).scaleX(0f).scaleY(0f).setListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationStart(Animator animator) {
...
//            item.itemView.setScaleX(1);
//            item.itemView.setScaleY(1);
